...
public class PlatformScriptCommandUnitTest {
    ...
    public static void main(String[] args) {
        ...
        String value = platformRedisClient.getPlatformScriptCommand().scriptLoad("return 123");

        List<Object> param = new ArrayList<Object>();
        param.add("1");

        Object t = platformRedisClient.getPlatformScriptCommand().evalSha("hello", "30dc9ef2a8d563dced9a243ecd0cc449c2ea0144", param, "2");
